...
class Toolbar {
  ...
  Toolbar(this.app, String id) {
    ...
    button = document.query("$id #battery-button");
    if (button != null) {
    ...
    button = document.query("$id #wire-button"); /* do not remove $id, it causes some errors! */
    if (button != null) {
      CssRect rect = button.borderEdge;
    ...
    button = document.query("$id #resistor-button");
    if (button != null) {
      CssRect rect = button.borderEdge;
    ...
    button = document.query("$id #bulb-button");
    if (button != null) {
      CssRect rect = button.borderEdge;
    ...
    button = document.query("$id #grid-button");
    if (button != null) button.onClick.listen((evt) => switchMode());
    
    button = document.query("$id #reset-button");
...
//     
    ...
    InputElement slider1 = document.query("#battery-slider");
    if (slider1 != null) {
    ...
    InputElement slider2 = document.query("#wire-slider");
    ...
    InputElement slider3 = document.query("#resistor-slider");
    if (slider3 != null) {
    ...
    InputElement slider4 = document.query("#bulb-slider");
    if (slider4 != null) {
  ...
  void createComponent(CssRect rect, String type) {
    ...
    switch (type) {
      case 'Battery':
        InputElement slider = query("#battery-slider");
...
//    print(value);
  InputElement slider = document.query(who);
...
void changeValue(String who, num value) {
  switch (who) {
    case 'battery-value':
      query("#battery-value").text = "Voltage = ${value}";
      break;
    case 'wire-value':
      break;
    case 'resistor-value':
      query("#resistor-value").text = "Resistance = ${value}";
      break;
    case 'bulb-value':
